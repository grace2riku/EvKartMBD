...
//}
モーターをカート本体に取り付けて動作確認すると大きなスペースが必要になるためモーターをEVカートから取り外して確認します。
...
No	構成品				内容										キット同梱
-------------------------------------------------------------------------------------------------------
1	インバーター基板	3相インバータ回路。FETが実装されている。			○
...
PCとUSBケーブルを接続し、インバータ基板の電源ONします。
...
シミュレーションはArduinoとシリアル通信を行い実現していますがArduino MEGAだとできます。
「External mode」と呼ばれていますが、Arduino UNOは対応していないためモニタリングできません。
