...
各相6個ずつ合計18スロットルを直列、または並列で巻きます。
//image[6serial][6直][scale=0.5]{
//}
//image[2serial_3parallel][2直3並][scale=0.5]{
//}
//image[3serial_2parallel][2直3並][scale=0.5]{
//}
...
CPU基板はこのタイミングでFETを通電・制御します。その結果モーターが回転します。@<br>{}
